...
foreach (var language in languages)
{
            ...
            page.Footer()
                ...
                .Column(c =>
                {
                    ...
                    c.Item().Row(row =>
                    {
                        ...
                        row.AutoItem()
                            .Text(
                                " for a better experience and the most updated information or other languages please visit the ");
    ...
    var saveDir = Path.Combine(outputDir);
    Directory.CreateDirectory(saveDir);
    var fileName = $"{cv.Language.ToString()}.pdf";
    document.GeneratePdf($"{saveDir}\\{fileName}");
    Console.WriteLine($"Generated {saveDir}\\{fileName} !");
}
